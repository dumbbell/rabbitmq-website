...
<table>
  <thead>
    <tr>
      <td>**Platform**</td>
      <td>**Default Configuration File Directory**</td>
      <td>**Example Configuration File Paths**</td>
    </tr>
  </thead>
...
<table class="name-description">
  ...
  <tr>
    ...
    <td>
      This environment variable is **only meant to be used in development and CI environments**.
