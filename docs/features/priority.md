...
However, in most cases, the previous situation is not the norm, therefore you should use the `basic.qos` ([prefetch](../other/confirms#channel-qos-prefetchconsumer-prefetch))
