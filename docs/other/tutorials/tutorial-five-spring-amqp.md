...
@Profile(&lcub;"tut5","topics"})
@Configuration
public class Tut5Config &lcub;

	@Bean
	public TopicExchange topic() &lcub;
	...
	private static class ReceiverConfig &lcub;
		...
		@Bean
		public Tut5Receiver receiver() &lcub;
...
public class Tut5Receiver &lcub;
...
public class Tut5Sender &lcub;
	...
	private final String[] keys = &lcub;"quick.orange.rabbit", "lazy.orange.elephant", "quick.orange.fox",
			"lazy.brown.fox", "lazy.pink.rabbit", "quick.brown.fox"};

	@Scheduled(fixedDelay = 1000, initialDelay = 500)
	public void send() &lcub;
		StringBuilder builder = new StringBuilder("Hello to ");
		if (this.index.incrementAndGet() == keys.length) &lcub;
			this.index.set(0);
		}
