...
@Profile(&lcub;"tut2", "work-queues"})
@Configuration
public class Tut2Config &lcub;
    ...
    private static class ReceiverConfig &lcub;
        ...
        @Bean
        public Tut2Receiver receiver1() &lcub;
            return new Tut2Receiver(1);
        }

        @Bean
        public Tut2Receiver receiver2() &lcub;
...
public class Tut2Sender &lcub;
	...
	public void send() &lcub;
		...
		if (dots.incrementAndGet() == 4) &lcub;
			dots.set(1);
		}
...
public class Tut2Receiver &lcub;

    private final int instance;

    public Tut2Receiver(int i) &lcub;
        this.instance = i;
    }

    @RabbitHandler
    public void receive(String in) throws InterruptedException &lcub;
