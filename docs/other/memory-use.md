...
description: Reasoning About Memory Use
weight: 10
---
...
by issuing a `GET` request to the `/api/nodes/&lcub;node}/memory` endpoint.
...
`GET` request to the `/api/nodes/&lcub;node}/memory` endpoint.
