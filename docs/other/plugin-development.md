...
&lcub;application, my_plugin,[
    %% ...
    &lcub;broker_version_requirements, ["3.11.15", "3.10.22"]}
]}
</pre>
...
&lcub;application, my_plugin, [
    %% ...
    &lcub;dependency_version_requirements, [&lcub;rabbitmq_management, ["3.11.0", "3.10.22"]}]}
]}
</pre>
