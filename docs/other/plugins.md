...
# => Error:
# => &lcub;:plugins_not_found, [:rabbitmq_managemenr]}
</pre>
...
# =>  Error:
# =>  &lcub;:enabled_plugins_mismatch, '/path/to/installation1/etc/rabbitmq/enabled_plugins', '/path/to/installation2/etc/rabbitmq/enabled_plugins'}
</pre>
