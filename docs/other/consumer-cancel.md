...
description: Consumer Cancel Notification
weight: 10
---
...
Consumer consumer = new DefaultConsumer(channel) &lcub;
    @Override
    public void handleCancel(String consumerTag) throws IOException &lcub;
