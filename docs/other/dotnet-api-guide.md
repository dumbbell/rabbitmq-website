...
description: .NET/C# Client API Guide
weight: 10
---
...
var endpoints = new System.Collections.Generic.List&lt;AmqpTcpEndpoint&gt; &lcub;
...
<pre class="lang-csharp">
channel.BasicReturn += (sender, ea) => &lcub;
    ...
};
</pre>
...
try &lcub;
  IConnection conn = factory.CreateConnection();
} catch (RabbitMQ.Client.Exceptions.BrokerUnreachableException e) &lcub;
  Thread.Sleep(5000);
  // apply retry logic
}
</pre>
...
var connectionFactory = new ConnectionFactory &lcub;
