...
description: Authentication, Authorisation, Access Control
weight: 10
---
...
connected user, the permission `^&lcub;username}-.*` is expanded to
`^tonyg-.*`
...
module. The <code>#amqp_params&lcub;}</code> record can be
