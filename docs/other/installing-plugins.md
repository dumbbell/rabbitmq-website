...
description: Installing Additional Plugins
weight: 10
---
...
<table>
  ...
  <tr>
    ...
    <td>
      <code>/usr/lib/rabbitmq/plugins</code> and <code>/usr/lib/rabbitmq/lib/rabbitmq_server-&lcub;<i>version</i>}/plugins</code>.
      <p>
  ...
  <tr>
    <th>Windows</th>
    <td>
      Typically <code>C:\Program Files\RabbitMQ\rabbitmq_server-&lcub;<i>version</i>}\plugins</code>
  ...
  <tr>
    <th>Homebrew</th>
    <td>
      <code>/usr/local/Cellar/rabbitmq/&lcub;<i>version</i>}/plugins</code>
    </td>
  </tr>
  <tr>
    <th>Generic Binary build</th>
    <td>
      <code>rabbitmq_server-&lcub;<i>version</i>}/plugins</code>
      (depending on RabbitMQ installation path)
    </td>
  </tr>
</table>
