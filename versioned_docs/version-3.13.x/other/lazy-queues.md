...
description: Classic Queues Operating in "Lazy" Queue Mode (A Lazy Queue)
weight: 10
---
...
<table>
  <tr>
    <th>rabbitmqctl</th>
    <td>
      <pre>rabbitmqctl set_policy Lazy "^lazy-queue$" '&lcub;"queue-mode":"lazy"}' --apply-to queues</pre>
    </td>
  </tr>
  <tr>
...
<table>
  <tr>
    <th>rabbitmqctl</th>
    <td>
      <pre>rabbitmqctl set_policy Lazy "^lazy-queue$" '&lcub;"queue-mode":"default"}' --apply-to queues</pre>
    </td>
  </tr>
  <tr>
    <th>rabbitmqctl (Windows)</th>
...
rabbitmq-diagnostics status | grep rss,
      &lcub;total,[&lcub;erlang,1043205272},&lcub;rss,770306048},&lcub;allocated,1103822848}]}]},

# Stop our temporary RabbitMQ node &amp; clean all persistent files
#
#       rabbitmqctl shutdown
#       rm -fr /tmp/&lcub;log,$RABBITMQ_NODENAME*}
</pre>
