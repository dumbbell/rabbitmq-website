...
description: Alternate Exchanges
weight: 10
---
...
<pre class="lang-bash">
rabbitmqctl set_policy AE "^my-direct$" '&lcub;"alternate-exchange":"my-ae"}' --apply-to exchanges
</pre>

Or, on Windows:

<pre class="lang-powershell">
rabbitmqctl.bat set_policy AE "^my-direct$" "&lcub;""alternate-exchange"":""my-ae""}" --apply-to exchanges
</pre>
