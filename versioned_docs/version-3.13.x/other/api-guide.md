...
<pre class="lang-java">
Address[] addrArr = new Address[]&lcub; new Address(hostname1, portnumber1)
...
<pre class="lang-java">
channel.addReturnListener(new ReturnListener() &lcub;
...
connection.addShutdownListener(new ShutdownListener() &lcub;
...
&lcub;
    try &lcub;
        ...
        channel.basicQos(1);
    } catch (ShutdownSignalException sse) &lcub;
        // possibly check if channel was closed
        // by the time we started action and reasons for
        // closing it
        ...
    } catch (IOException ioe) &lcub;
...
<pre class="lang-java">
public interface AddressResolver &lcub;
...
Address[] addresses = &lcub;new Address("192.168.1.4"), new Address("192.168.1.5")};
...
try &lcub;
  Connection conn = factory.newConnection();
} catch (java.net.ConnectException e) &lcub;
  Thread.sleep(5000);
  // apply retry logic
}
</pre>
