...
```bash
username="$(kubectl get secret hello-world-default-user -o jsonpath='&lcub;.data.username}' | base64 --decode)"
echo "username: $username"
password="$(kubectl get secret hello-world-default-user -o jsonpath='&lcub;.data.password}' | base64 --decode)"
...
&lcub;"management_version":"3.8.9","rates_mode":"basic", ...}
```
...
username="$(kubectl get secret hello-world-default-user -o jsonpath='&lcub;.data.username}' | base64 --decode)"
password="$(kubectl get secret hello-world-default-user -o jsonpath='&lcub;.data.password}' | base64 --decode)"
service="$(kubectl get service hello-world -o jsonpath='&lcub;.spec.clusterIP}')"
