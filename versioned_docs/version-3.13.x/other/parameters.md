...
<table>
  <tr>
    <th>rabbitmqctl</th>
    <td>
      `rabbitmqctl set_parameter [-p <i>vhost</i>] &lt;component_name> &lt;name&gt; &lt;value&gt;`<br/>
      `rabbitmqctl clear_parameter [-p <i>vhost</i>] &lt;component_name&gt; &lt;name&gt;`<br/>
      `rabbitmqctl list_parameters [-p <i>vhost</i>]`
    </td>
  </tr>
  <tr>
    <th>HTTP API</th>
    <td>
      `PUT /api/parameters/<i>{component_name}</i>/<i>{vhost}</i>/<i>{name}</i>`<br/>
      `DELETE /api/parameters/<i>{component_name}</i>/<i>{vhost}</i>/<i>{name}</i>`<br/>
...
<table>
  ...
  <tr>
    <th>HTTP API</th>
    <td>
      `PUT /api/global-parameters/<i>name</i>`<br/>
      `DELETE /api/global-parameters/<i>name</i>`<br/>
