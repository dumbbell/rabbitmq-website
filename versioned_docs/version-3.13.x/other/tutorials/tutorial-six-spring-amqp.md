...
@Profile(&lcub;"tut6","rpc"})
@Configuration
public class Tut6Config &lcub;

	@Profile("client")
	private static class ClientConfig &lcub;

		@Bean
		public DirectExchange exchange() &lcub;
			return new DirectExchange("tut.rpc");
		}

		@Bean
		public Tut6Client client() &lcub;
	...
	@Profile("server")
	private static class ServerConfig &lcub;

		@Bean
		public Queue queue() &lcub;
