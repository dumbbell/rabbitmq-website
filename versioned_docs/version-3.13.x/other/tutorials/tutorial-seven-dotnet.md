...
&lcub;
    ...
    Console.WriteLine($"Message with body &lcub;body} has been nack-ed. Sequence number: &lcub;ea.DeliveryTag}, multiple: &lcub;ea.Multiple}");
...
&lcub;
    var factory = new ConnectionFactory &lcub; HostName = "remote-host", UserName = "remote-host", Password = "remote-password" };
