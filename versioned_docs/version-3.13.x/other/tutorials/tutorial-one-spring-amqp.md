...
@Profile(&lcub;"tut1","hello-world"})
@Configuration
public class Tut1Config &lcub;

    @Bean
    public Queue hello() &lcub;
        return new Queue("hello");
    }

    @Profile("receiver")
    @Bean
    public Tut1Receiver receiver() &lcub;
        return new Tut1Receiver();
    }

    @Profile("sender")
    @Bean
    public Tut1Sender sender() &lcub;
...
@EnableScheduling
public class RabbitAmqpTutorialsApplication &lcub;

    @Profile("usage_message")
    @Bean
    public CommandLineRunner usage() &lcub;
        return args -> &lcub;
    ...
    @Profile("!usage_message")
    @Bean
    public CommandLineRunner tutorial() &lcub;
        return new RabbitAmqpTutorialsRunner();
    }

    public static void main(String[] args) throws Exception &lcub;
...
public class RabbitAmqpTutorialsRunner implements CommandLineRunner &lcub;

    @Value("$&lcub;tutorial.client.duration:0}")
    ...
    @Override
    public void run(String... arg0) throws Exception &lcub;
...
public class Tut1Receiver &lcub;

    @RabbitHandler
    public void receive(String in) &lcub;
