...
channel.BasicPublish(exchange: "direct_logs",
                     ...
                     basicProperties: null,
                     body: body);
Console.WriteLine($" [x] Sent '&lcub;severity}':'&lcub;message}'");
...
if (args.Length &lt; 1)
&lcub;
    Console.Error.WriteLine("Usage: &lcub;0} [info] [warning] [error]",
...
&lcub;
    ...
    Console.WriteLine($" [x] Received '&lcub;routingKey}':'&lcub;message}'");
};
