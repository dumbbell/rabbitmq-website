...
```java
@Bean
public DirectExchange direct() &lcub;
...
@Profile(&lcub;"tut4","routing"})
@Configuration
public class Tut4Config &lcub;
	...
	private static class ReceiverConfig &lcub;
		...
		@Bean
		public Tut4Receiver receiver() &lcub;
...
public class Tut4Sender &lcub;
	...
	private final String[] keys = &lcub;"orange", "black", "green"};

	@Scheduled(fixedDelay = 1000, initialDelay = 500)
	public void send() &lcub;
		StringBuilder builder = new StringBuilder("Hello to ");
		if (this.index.incrementAndGet() == 3) &lcub;
			this.index.set(0);
		}
...
public class Tut4Receiver &lcub;
