...
In the following table the `$&lcub;install_prefix}` to
...
<table>
  ...
  <tr>
    <td>RABBITMQ_CONFIG_FILE</td>
    <td>
      <span class="path"><span class="envvar">$&lcub;install_prefix}</span>/etc/rabbitmq/rabbitmq</span>
    </td>
  </tr>
  <tr>
    <td>RABBITMQ_MNESIA_BASE</td>
    <td>
      <span class="path"><span class="envvar">$&lcub;install_prefix}</span>/var/lib/rabbitmq/mnesia</span>
    </td>
  </tr>
  ...
  <tr>
    <td>RABBITMQ_LOG_BASE</td>
    <td>
      <span class="path"><span class="envvar">$&lcub;install_prefix}</span>/var/log/rabbitmq</span>
    </td>
  </tr>
  ...
  <tr>
    <td>RABBITMQ_ENABLED_PLUGINS_FILE</td>
    <td>
      <span class="path"><span class="envvar">$&lcub;install_prefix}</span>/etc/rabbitmq/enabled_plugins</span>
    </td>
  </tr>
